...
public class Principal{
    ...
    static void  inicia(){
        ...
        for(int i=0;i<no_predios;i++){
            ...
            predios.add(new Predio((i+1)*100,4));
    ...
    static void insere_morador(){
       ...
       int ano = 2000;
        ...
        Date data_saida = data.getTime();
//String nome,String genero,Date data_nascimento,int ano_ingresso,Date previsao_saida,Date data_saida
        Morador morador = new Morador(nome, genero, data_nascimento, ano, previsao_saida);
        ...
        int ID_desejado = 114;
        Apartamento desejado,temp1; 
        desejado = new Apartamento(0,true);
        Iterator < Apartamento > iterator = apartamentos.iterator(); 
        do
        {temp1 = iterator.next();
         int comp = temp1.get_ID();
         if(comp == ID_desejado)
         {desejado = temp1;
         }
        }while( iterator.hasNext() ); 
        System.out.println(desejado.get_ID() +  "\n" + desejado.getNo_ocupantes() +  "\n" + desejado.getGenero());
    }

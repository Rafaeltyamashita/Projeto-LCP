...
import javax.swing.JOptionPane;
 public class BD {
    ...
    int i = 1;
    try{
    INSERT_RECORD = ("UPDATE Predio SET ID = ? WHERE ID = ?");
   ...
   int retorno = pstmt.executeUpdate();//coloca a statement insery_record em executeUpdate para atualizar o valor
    ...
    //update_tabela2 utiliza o campo ID para encontrar o local para trocar os valores
    //neste caso um valor Date
    public static int update_Tabela(Date Valor_troca,String Tabela,String Campo,int ID){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    //Cria a statement para inserir os campos de Morador
    String INSERT_RECORD;
    INSERT_RECORD = ("UPDATE " + Tabela + " SET " + Campo + " = ? where ID = ?");
    
    PreparedStatement pstmt = con.prepareStatement(INSERT_RECORD);
    pstmt.setDate(1, Valor_troca); //seta primeira ?
    pstmt.setInt(2,ID);  //seta segunda ?
    ...
    //neste caso um valor String
    public static int update_Tabela(String Valor_troca,String Tabela,String Campo,int ID){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    //neste caso um valor int
    public static int update_Tabela(int Valor_troca,String Tabela,String Campo,int ID){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    {JOptionPane.showMessageDialog(null,"Valor procurado não pertence a nenhum Morador");   
    }
    stm.execute("SHUTDOWN");
    }catch(ClassNotFoundException e){
    System.out.println("Erro ao carregar o driver JDBC. ");
   ...
   public static void seleciona_Tabela(int Valor_compara,String Tabela,String Campo){
    ...
    //Recebe o valor de um campo e indica o campo assim como a tabela consultada
    //retorna o ID de todos os objetos com este valor
    //caso o campo for previsao de saida,data_saida,data_nascimento 
    public static void seleciona_Tabela2(Date Valor_compara,String Tabela,String Campo){
    try{
    String lista = "";
    int ID;
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    ...
    //caso campo é Nome ou Genero
    public static void seleciona_Tabela2(String Valor_compara,String Tabela,String Campo){
    try{
    String lista = "";
    int ID;
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    ...
    System.out.println("Erro de SQL: "+e);    
     ...
     //caso campo é idade,ano_de_ingresso,predio,bloco,apartamento,advertencias
    public static void seleciona_Tabela2(int Valor_compara,String Tabela,String Campo){
    try{
    String lista = "";
    int ID;
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    ...
    // usado para pegar o numero de pessoas da tabela em relação ao ID
    ...
    //retorna valor em relação ao nome
    public static int get_Int(String Campo,String Tabela,String nome){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    String r = rs.getString("Nome");
        if(r.equals(nome))
        {int ret = rs.getInt(Campo);
         return ret; //retorna numero de moradores do campo informado
        }
    }
    stm.execute("SHUTDOWN");
    }catch(ClassNotFoundException e){
    ...
    // usado para pegar uma string da tabela
    public static String get_String(String Campo,String Tabela,String nome){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    return null;
     ...
     // usado para pegar um Date da tabela
    public static Date get_Date(String Campo,String Tabela,String nome){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    public static int seleciona_Morador(String Nome,String Tabela){
    try{
    Class.forName("org.hsqldb.jdbcDriver"); //acessa driver do banco de dados
    //estabelece conexão com o baco de dados
    Connection con = DriverManager.getConnection("jdbc:hsqldb:file:C:\\Users\\rafae\\Downloads\\Unesp\\LCP\\Projeto-LCP\\Banco de Dados\\BD", "sa", ""); //CAMPOS UR/Login/senha
    ...
    //impede que mais de 3 IDs sejam criados
